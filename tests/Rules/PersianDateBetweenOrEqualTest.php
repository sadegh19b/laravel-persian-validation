...
use Sadegh19b\LaravelPersianValidation\Rules\PersianDateBetweenOrEqual;
use Sadegh19b\LaravelPersianValidation\Tests\TestCase;

class PersianDateBetweenOrEqualTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->rule = new PersianDateBetweenOrEqual(
            startDate: '1402/01/01',
            endDate: '1404/01/01'
        );
        $this->rulePersian = new PersianDateBetweenOrEqual(
            startDate: '1402/01/01',
            endDate: '1404/01/01',
            convertPersianNumbers: true
        );
        $this->ruleSeparator = new PersianDateBetweenOrEqual(
            startDate: '1402-01-01',
            endDate: '1404-01-01',
            separator: '-'
        );
    ...
    {
        $this->assertValidationFails($value, 'persian_date_between_or_equal', $this->rule);
    }
    ...
    {
        $this->assertValidationFails($value, 'persian_date_between_or_equal', $this->rulePersian);
    }
    ...
    {
        $this->assertValidationFails($value, 'persian_date_between_or_equal', $this->ruleSeparator);
    }
    ...
    public function it_throws_exception_for_invalid_before_after_dates(): void
    {
        ...
        $rule = new PersianDateBetweenOrEqual(
