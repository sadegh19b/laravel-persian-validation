...
use Sadegh19b\LaravelPersianValidation\Rules\PersianDateBetweenOrEqualYear;
use Sadegh19b\LaravelPersianValidation\Tests\TestCase;

class PersianDateBetweenOrEqualYearTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->rule = new PersianDateBetweenOrEqualYear(
            startYear: '1402',
            endYear: '1404'
        );
        $this->rulePersian = new PersianDateBetweenOrEqualYear(
            startYear: '1402',
            endYear: '1404',
            convertPersianNumbers: true
        );
        $this->ruleSeparator = new PersianDateBetweenOrEqualYear(
            startYear: '1402',
            endYear: '1404',
            separator: '-'
        );
    ...
    {
        $this->assertValidationFails($value, 'persian_date_between_or_equal_year', $this->rule);
    }
    ...
    {
        $this->assertValidationFails($value, 'persian_date_between_or_equal_year', $this->rulePersian);
    }
    ...
    {
        $this->assertValidationFails($value, 'persian_date_between_or_equal_year', $this->ruleSeparator);
    }
    ...
    public function it_throws_exception_for_invalid_before_after_years(): void
    {
        ...
        $rule = new PersianDateBetweenOrEqualYear(
