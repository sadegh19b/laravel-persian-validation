...
class PersianDateBetween implements ValidationRule
{
     ...
     *
     * Persian Date Between validation:
     *
     * Validates:
     * - Validates if a date falls between two given Persian dates (exclusive)
     ...
     *
     * Notes:
     * - Start date must be before of end date
     * - End date must be after of start date
     * - Both start and end dates must be valid Persian dates
     * - Value must be strictly between start and end dates (not equal to either)
     *
